    ...
    [
      ...
      describe "#{method} #{path}" do
        ...
        it "redirects to the admin profile page" do
          expect(response).to redirect_to("https://moderate.petition.parliament.uk/admin/profile/#{moderator.id}/edit?locale=en-GB")
        end
      end
      ...
      describe "sending email to the creators" do
        ...
        context "with valid params" do
          ...
          it "redirects to the overdue petitions page" do
            expect(response).to redirect_to("https://moderate.petition.parliament.uk/admin/petitions?locale=en-GB&state=overdue_in_moderation")
          end
